...
import { User, Mailbox, Phone, MessageSquare, MessageCircleDashed, SendHorizonal, MessageCircle } from "lucide-react";
...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if(!validatePhone(formData.phone)) {
      setPhoneError('Please enter a valid 11-digits mobile number')
      return;
    }
    ...
    const whatsappUrl = `https://wa.me/+8801857329586?text=${whatsappMessage}`;
